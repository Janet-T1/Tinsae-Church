    ...
    return (
        <div className="flex flex-col items-center justify-center w-screen m-0 p-10 bg-secondary h-1/2">
            ...
            <div className="flex flex-col items-center bg-red-500 p-10 bg-red w-screen">
                <h1 className="text-white text-5xl mb-6 font-semibold">CONTACT US HERE</h1>
                <button className="bg-white hover:bg-[#EFEFEF] rounded-sm p-3 text-smalltext font-semibold shadow-md">
                    CONTACT CARD
                </button>
            </div>
        </div>
